...
public class UsingCatalogSteps extends AbstractSteps {
    ...
    @Step
    public void userSortsProductsOnThePage(String expectedSortingOption) {
    ...
    @Step
    public void priceFilterShouldBeApplied(String expectedPriceRange) {
        Assert.assertEquals("Price filter is not set as expected", expectedPriceRange, catalogPage.getPriceRange());
    }

    @Step
    public void sortingOptionShouldBeApplied(String expectedSortingOption) {
